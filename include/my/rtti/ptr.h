...
namespace my
{
    template <RttiObjectBase = IRttiObject>
    class UniqueRttiPtr;

    template <RttiObjectBase = IRefCounted>
    class Ptr;

    /**
     */
    template <RttiObjectBase T>
    class UniqueRttiPtr
    {
        template <RttiObjectBase>
    ...
    public:
        ...
        {
            AssignMaybeCompatible(other.m_ptr);
            return *this;
        }
